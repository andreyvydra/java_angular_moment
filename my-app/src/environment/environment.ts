export const backendURL: String = "http://localhost:20351/lab/api";

export const yMin: number = -3;
export const yMax: number = 5;
export const rMin: number = 1;
export const rMax: number = 4;
